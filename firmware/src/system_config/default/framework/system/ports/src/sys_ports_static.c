...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_CHANGE_NOTICE_G);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_CHANGE_NOTICE_G, INT_PRIORITY_LEVEL1);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_CHANGE_NOTICE_G, INT_SUBPRIORITY_LEVEL0);


    /* PPS Input Remapping */
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U3RX, INPUT_PIN_RPG6 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U1RX, INPUT_PIN_RPA7 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U2RX, INPUT_PIN_RPG7 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U4RX, INPUT_PIN_RPG9 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_SDI4, INPUT_PIN_RPA1 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_SDI5, INPUT_PIN_RPA15 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_SDI3, INPUT_PIN_RPE0 );

    /* PPS Output Remapping */
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U2TX, OUTPUT_PIN_RPD3 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U3TX, OUTPUT_PIN_RPD4 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U4TX, OUTPUT_PIN_RPA12 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK4, OUTPUT_PIN_RPA11 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U1TX, OUTPUT_PIN_RPC0 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK3, OUTPUT_PIN_RPE15 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK5, OUTPUT_PIN_RPC10 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK3, OUTPUT_PIN_RPE15 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO4, OUTPUT_PIN_RPA8 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO5, OUTPUT_PIN_RPA14 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK5, OUTPUT_PIN_RPC10 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO3, OUTPUT_PIN_RPE1 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK4, OUTPUT_PIN_RPA11 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK4, OUTPUT_PIN_RPA11 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SCK3, OUTPUT_PIN_RPE15 );
