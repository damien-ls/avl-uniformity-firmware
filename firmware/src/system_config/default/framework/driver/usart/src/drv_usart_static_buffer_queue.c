...
// *****************************************************************************
// *****************************************************************************
void DRV_USART2_BufferAddWrite (DRV_USART_BUFFER_HANDLE * bufferHandle, void * source, const size_t nBytes)
{
    /* This function adds a buffer to the write queue */
    ...
    *bufferHandle = DRV_USART_BUFFER_HANDLE_INVALID;
    ...
    if(dObj->queueWrite == NULL)
    {
        ...
        bufferObj->nCurrentBytes ++;
        PLIB_USART_TransmitterByteSend(USART_ID_3, bufferObj->buffer[0]);
    }
    else
    {
        /* This means the write queue is not empty. We must add
...
void DRV_USART2_BufferAddRead(DRV_USART_BUFFER_HANDLE * const bufferHandle,void * destination,const size_t nBytes)
{
    /* This function adds a buffer to the read queue */
    DRV_USART_OBJ *dObj = (DRV_USART_OBJ*)NULL;
    DRV_USART_BUFFER_OBJ * bufferObj = NULL;
...
// *****************************************************************************
// *****************************************************************************
void DRV_USART3_BufferAddWrite (DRV_USART_BUFFER_HANDLE * bufferHandle, void * source, const size_t nBytes)
{
    /* This function adds a buffer to the write queue */
...
void DRV_USART3_BufferAddRead(DRV_USART_BUFFER_HANDLE * const bufferHandle,void * destination,const size_t nBytes)
{
    /* This function adds a buffer to the read queue */
    DRV_USART_OBJ *dObj = (DRV_USART_OBJ*)NULL;
    DRV_USART_BUFFER_OBJ * bufferObj = NULL;
...
// *****************************************************************************
// *****************************************************************************
void DRV_USART4_BufferAddWrite (DRV_USART_BUFFER_HANDLE * bufferHandle, void * source, const size_t nBytes)
{
    /* This function adds a buffer to the write queue */
    ...
    *bufferHandle = DRV_USART_BUFFER_HANDLE_INVALID;
    ...
    if(dObj->queueWrite == NULL)
    {
        ...
        bufferObj->nCurrentBytes ++;
        PLIB_USART_TransmitterByteSend(USART_ID_5, bufferObj->buffer[0]);
    }
    else
    {
        /* This means the write queue is not empty. We must add
...
void DRV_USART4_BufferAddRead(DRV_USART_BUFFER_HANDLE * const bufferHandle,void * destination,const size_t nBytes)
{
    /* This function adds a buffer to the read queue */
    DRV_USART_OBJ *dObj = (DRV_USART_OBJ*)NULL;
    DRV_USART_BUFFER_OBJ * bufferObj = NULL;
...
extern DRV_USART_OBJ  gDrvUSART5Obj ;
...
// *****************************************************************************
// *****************************************************************************
void DRV_USART5_BufferAddWrite (DRV_USART_BUFFER_HANDLE * bufferHandle, void * source, const size_t nBytes)
{
    /* This function adds a buffer to the write queue */
    ...
    *bufferHandle = DRV_USART_BUFFER_HANDLE_INVALID;
    ...
    if(dObj->queueWrite == NULL)
    {
        ...
        bufferObj->nCurrentBytes ++;
        PLIB_USART_TransmitterByteSend(USART_ID_6, bufferObj->buffer[0]);
    }
    else
    {
        /* This means the write queue is not empty. We must add
...
void DRV_USART5_BufferAddRead(DRV_USART_BUFFER_HANDLE * const bufferHandle,void * destination,const size_t nBytes)
{
    /* This function adds a buffer to the read queue */
    DRV_USART_OBJ *dObj = (DRV_USART_OBJ*)NULL;
    DRV_USART_BUFFER_OBJ * bufferObj = NULL;
